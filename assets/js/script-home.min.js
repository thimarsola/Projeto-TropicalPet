...
item.preloaded=!0}}});var RETINA_NS='retina';$.magnificPopup.registerModule(RETINA_NS,{options:{replaceSrc:function(item){return item.src.replace(/\.\w+$/,function(m){return'@2x'+m})},ratio:1},proto:{initRetina:function(){if(window.devicePixelRatio>1){var st=mfp.st.retina,ratio=st.ratio;ratio=!isNaN(ratio)?ratio:ratio();if(ratio>1){_mfpOn('ImageHasSize'+'.'+RETINA_NS,function(e,item){item.img.css({'max-width':item.img[0].naturalWidth/ratio,'width':'100%'})});_mfpOn('ElementParse'+'.'+RETINA_NS,function(e,item){item.src=st.replaceSrc(item,ratio)})}}}}});_checkInstance()}));$(function(){$('.gallery__row').magnificPopup({delegate:'a',type:'image',gallery:{enabled:!0}})});$(function(){var speed=1000;$('.faq__row__container__content__item__header').on("click",function(){$('.faq__row__container__content__item__body').stop().slideUp(speed);$(this).parent().find('.faq__row__container__content__item__body').slideToggle()})})