                ...
                <div class="contact__form__row__information">
                    ...
                    <div class="contact__form__row__information__phones">
                        ...
                        <div class="contact__form__row__information__phones__body">
                            <ul>
                                <li>
                                    <a rel="nofollow noreferrer noopener" href="tel:<?= formatPhone(CONTACT["phone"]["01"]); ?>" title="Vamos conversar?"><?= CONTACT["phone"]["01"]; ?></a>
                                </li>
                                <li>|</li>
                                <li>
                                    <a rel="nofollow noreferrer noopener" href="tel:<?= formatPhone(CONTACT["phone"]["02"]); ?>" title="Vamos conversar?"><?= CONTACT["phone"]["02"]; ?></a>
                                </li>
                                <li>|</li>
                                <li>
                    ...
                    <div class="contact__form__row__information__mail">
                        ...
                        <div class="contact__form__row__information__mail__body">
                            <address>
                                <a rel="nofollow noreferrer noopener" href="mailto:<?= CONTACT['mail']; ?>" title="Vamos conversar?"><?= CONTACT['mail']; ?></a>
                            </address>
                        </div>
                        <!-- end of body -->
                    </div>
                    ...
                    <div class="contact__form__row__information__address">
                        ...
                        <div class="contact__form__row__information__address__body">
                            <address>
                                <a rel="nofollow noreferrer noopener" href="<?= CONTACT['addressLink']; ?>" target="_blank" title="Venha nos visitar!"><?= CONTACT['address']; ?></a>
                            </address>
                        </div>
                        <!-- end of body -->
                    </div>
                    ...
                    <div class="contact__form__row__information__midias">
                        ...
                        <!-- body -->
                        <div class="contact__form__row__information__midias__body">
                            <ul>
                                <li>
                                    <a rel="nofollow noreferrer noopener" href="<?= CONTACT['facebook']; ?>" title="Siga a <?= SITE['name']; ?> no Facebook" target="_blank"><i class="pet-facebook"></i></a>
                                </li>
                                <li>
                                    <a rel="nofollow noreferrer noopener" href="<?= CONTACT['instagram']; ?>" title="Siga a <?= SITE['name']; ?> no Instagram" target="_blank"><i class="pet-instagram"></i></a>
                                </li>
                            </ul>
                        </div>
                        <!-- end of body -->
                ...
                <div class="contact__form__row__form">
                    <form id="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="contact__form__row__form__group">
                            ...
                            <textarea id="message" name="message" cols="50" rows="4" placeholder="Escreva sua mensagem"></textarea>
                        </div>
                        <!-- end of group -->
